        ...
        tt = function() {
            ...
            return a(t, [{
                ...
                value: function(t, e) {
                    ...
                    if (null === i && (i = this.isBarDistributed || this.isHeatmapDistributed || "heatmap" === a.config.chart.type && a.config.plotOptions.heatmap.colorScale.inverse), i && (s = a.globals.series[a.globals.maxValsInArrayIndex].length * a.globals.series.length), t.length < s)
            ...
            return a(t, [{
                ...
                value: function() {
                    ...
                    ("radar" === e.config.chart.type || this.isSparkline) && (o = 0, l = i.goldenPadding), this.isSparkline && (this.lgRect = {
                        height: 0,
                        width: 0
                    }), (this.isSparkline || "treemap" === e.config.chart.type) && (o = 0, l = 0, h = 0), e.config.xaxis.show && this.dimXAxis.additionalPaddingXLabels(r);
                    var c = function() {
        ...
        yt = function() {
            ...
            return a(t, [{
                ...
                value: function(t, e, i, a) {
                    ...
                    r = s.globals.hasNegs || a ? s.config.plotOptions[t].reverseNegativeShade ? o.percent < 0 ? o.percent / 100 * (1.25 * n) : (1 - o.percent / 100) * (1.25 * n) : o.percent <= 0 ? 1 - (1 + o.percent / 100) * n : (1 - o.percent / 100) * n : (1 - o.percent / 100) * (1.25 * n);
                    var l = o.color,
                        h = new f;
                ...
                value: function(t) {
                    ...
                    return t.forEach((function(t) {
                        ...
                        n.forEach((function(r, n) {
                            ...
                            e.rotateToFitLabel(A, k, h, c, d, g), l.add(u), null !== A && l.add(A)
                        })), l.add(h), r.add(l)
                    })), r
                }
            }, {
                ...
                value: function(t, e) {
                    ...
                    if (s.comboCharts) {
                        ...
                        case "bar":
                            ...
                            else x = new X(this.ctx, e).draw(s.series);
                            break;
                        case "candlestick":
